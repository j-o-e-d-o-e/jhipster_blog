package net.joedoe.repository;

import net.joedoe.BlogApp;
import net.joedoe.config.Constants;
import net.joedoe.config.audit.AuditEventConverter;
import net.joedoe.domain.PersistentAuditEvent;
...
import static net.joedoe.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
